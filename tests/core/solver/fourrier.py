...
class TestSolver(unittest.TestCase):
    def setUp(self):
        ...
        self.and_dn = DeepNetwork.from_matrices('test', mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                tau=self.tau)
        ...
        self.xor_dn = DeepNetwork.from_matrices('test', mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                tau=self.tau)
        ...
        self.tree_dn = DeepNetwork.from_matrices('test', mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                 tau=self.tau)
    ...
    def test_and_pattern(self):
        ...
        # Create solver
        solver = DeepNetSolver(self.and_dn, self.and_pat.delay, imputer, 'fourrier', p0=1)
    ...
    def test_xor_pattern(self):
        ...
        solver = DeepNetSolver(self.xor_dn, self.xor_pat.delay, imputer, 'fourrier', p0=1)
    ...
    def test_tree_pattern(self):
        ...
        # Create solver
        solver = DeepNetSolver(self.tree_dn, self.tree_pat.delay, imputer, 'fourrier', p0=1)
        l_t_epoch, l_t_forwardp, l_t_forwardt, l_t_backwardp, l_t_backwardt = solver.run_fourrier_epoch_analysis(100)
