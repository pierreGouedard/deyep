...
class TestSolver(unittest.TestCase):
    def setUp(self):
        ...
        self.and_dn = DeepNetwork.from_matrices(mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                tau=self.tau)
        ...
        self.xor_dn = DeepNetwork.from_matrices(mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                tau=self.tau)
        ...
        self.tree_dn = DeepNetwork.from_matrices(mat_net, mat_in, mat_out, 100, 'fourrier', w0=self.wo, l0=self.l0,
                                                 tau=self.tau)
